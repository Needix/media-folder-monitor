...
public class FolderMonitor {
    ...
    private static final Path MUSIC_DESTINATION = Paths.get("/mnt/nashomes/nasbackup/media/Music/New/");
    private static final Path MP3_TOCOPY_DESTINATION = Paths.get("/mnt/nashomes/nasbackup/media/MP3ToCopy/");
    private static final Path MP3_UNSORTED_DESTINATION = Paths.get("/mnt/nashomes/nasbackup/media/MP3/Unsorted/");
